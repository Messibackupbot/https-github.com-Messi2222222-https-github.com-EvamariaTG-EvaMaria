...
async def next_page(bot, query):
    ...
    if n_offset == 0:
        btn.append(
            [InlineKeyboardButton("⏪ ⚡️ BACK ⚡️", callback_data=f"next_{req}_{key}_{off_set}"),
        ...
        btn.append(
            [
                InlineKeyboardButton("⏪ ⚡️ BACK ⚡️", callback_data=f"next_{req}_{key}_{off_set}"),
                InlineKeyboardButton(f"🗓 {round(int(offset) / 10) + 1} / {round(total / 10)}", callback_data="pages"),
                InlineKeyboardButton("⚡️ NEXT ⚡️ ⏩", callback_data=f"next_{req}_{key}_{n_offset}")
            ]
        )
    try:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🏠 ⚡️ Home ⚡️', callback_data='start'),
        ...
        buttons = [[
            InlineKeyboardButton('🤖 ⚡️ Updates ⚡️', url='https://t.me/newsofbot2022'),
            InlineKeyboardButton('♥️ ⚡️ Source ⚡️', callback_data='source')
        ], [
            InlineKeyboardButton('🏠 ⚡️ Home ⚡️', callback_data='start'),
